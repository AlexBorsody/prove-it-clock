...
## Promise Fulfilled?
We must compare all metrics to eventuall determine if promise is fulfilled this will determine if the project hit's its goal and actually wins. So far no crypto has really done this, case can only be made for BTC as a store of value. Untill we get there we will measure realism vs potential.

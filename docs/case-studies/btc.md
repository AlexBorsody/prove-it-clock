...
- **El Salvador is context, not a heart event:** a government mandate is
  adoption, not fulfillment of the global-cash core, the core stays open.
- **Payment-volume figures are aggregator-sourced** (merchant counts, Lightning
  capacity) and need primary verification before anyone calls this verified.

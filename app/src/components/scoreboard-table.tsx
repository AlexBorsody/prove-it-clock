...
function CodeWordCell({ code }: { code: CodeWord }) {
              ...
              <td>
                <div className="mini-meter">
                  <div className="mini-meter-track">
                    <div className="mini-meter-fill" style={{ width: `${Math.round(r.filledPct * 100)}%` }} />
                  </div>
                  <span className="num mini-meter-val">{r.earned}/{r.capacity}</span>
                </div>
              </td>
              <td><VerdictBadge category={r.verdict} compact /></td>
              <td><CodeWordCell code={r.code} /></td>
